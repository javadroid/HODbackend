...
app.use(cors({
    origin:["http://localhost:3001","http://localhost:3000","https://blvz.vercel.app","https://project1-w4sy.onrender.com","http://localhost:3000","http://localhost:5173","https://wa-frontend-4fcn.onrender.com"]
}))
